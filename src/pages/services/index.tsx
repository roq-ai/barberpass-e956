            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>name</Th>
                  <Th>description</Th>
                  {hasAccess('barbershop', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>barbershop</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('barbershop', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/barbershops/view/${record.barbershop?.id}`}>
                          {record.barbershop?.name}
                        </Link>
                      </Td>
                    )}
