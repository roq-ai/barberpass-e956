...
function SubscriptionListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('subscription', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/subscriptions/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('subscription', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/subscriptions/create`} passHref legacyBehavior>
